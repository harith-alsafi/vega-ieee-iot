...
\author{Harith Al-Safi, Harith Ibrahim and Paul Steenson, \IEEEmembership{Senior Member, IEEE}
        % <-this % stops a space
\thanks{This work was supported in part by the school of Electronics and Electrical Engineering at the University of Leeds.}% <-this % stops a space
...
\begin{figure*}[!t]
  ...
  \caption{\centering \textbf{Architecture code design of the RPi including the control server and the database}}
  \label{fig3}
  \end{figure*}
...
\begin{table}[!h]
    \caption{\textbf{Defined functions on the control server, called by the LLM based on user input and executes on the RPi}}
    \label{table2}
    \setlength{\tabcolsep}{3pt}
...
\begin{figure*}[!t]
  ...
  \caption{\centering \textbf{Web app user interface implementation showcasing (a) Mobile Version alongside (b) Desktop Version}}
  \label{fig4}
  \end{figure*}
...
\begin{figure*}[!t]
  ...
  \caption{\centering \textbf{Web app logic in action featuring LLM agents, application states and RPi connection}}
  \label{fig5}
  \end{figure*}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.99\columnwidth]{images/fig6.png}
  \caption{\centering \textbf{Execution of the LLM Chat Agent}}
  \label{fig6}
  \end{figure}
...
\begin{figure*}[!t]
  ...
  \caption{\centering \textbf{Case study of complex commands in action}}
  \label{fig7}
  \end{figure*}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.99\columnwidth]{images/fig8.png}
  \caption{\centering \textbf{Evaluation Process integrated within Vega.}}
  \label{fig8}
  \end{figure}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.99\columnwidth]{images/fig9.png}
  \caption{\centering \textbf{Evaluation metrics for the functions defined in Table \ref{table2}.}}
  \label{fig9}
  \end{figure}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.32]{images/fig10.png}
  \caption{\centering \textbf{Message complexity against the number of functions called per message.}}
  \label{fig10}
  \end{figure}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.99\columnwidth]{images/fig11.png}
  \caption{\centering \textbf{Heatmap for success rate against message complexity and temperature of the LLM.}}
  \label{fig11}
  \end{figure}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.38]{images/fig12.png}
  \caption{\centering \textbf{Heatmap for success rate against message complexity and temperature of the LLM.}}
  \label{fig12}
  \end{figure}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.99\columnwidth]{images/fig13.png}
  \caption{\centering \textbf{Heatmap for success rate against message complexity and Top P of the LLM.}}
  \label{fig13}
  \end{figure}
...
\begin{figure}[!h]
  ...
  \caption{\centering \textbf{What types of errors occurred throughout testing.}}
  \label{fig14}
  \end{figure}
...
\begin{figure}[!h]
  ...
  \caption{\centering \textbf{Success rate of different tones of the same message.}}
  \label{fig15}
  \end{figure}
